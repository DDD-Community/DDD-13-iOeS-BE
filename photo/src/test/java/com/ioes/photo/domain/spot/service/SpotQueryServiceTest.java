...
class SpotQueryServiceTest {
    ...
    class FindSpotsInViewport {
        ...
        void returnsSummariesWithThumbnail_whenSpotsFound() {
            ...
            given(spotMapper.findSpotsInViewport(37.5, 37.6, 127.0, 127.1, PUBLISHED_CODE, null, List.of(1L)))
        ...
        void passesThemeCodeToMapper() {
            given(spotMapper.findSpotsInViewport(37.5, 37.6, 127.0, 127.1, PUBLISHED_CODE, List.of(SpotTheme.SUNSET.getCode()), List.of(1L)))
                .willReturn(List.of());

            spotQueryService.findSpotsInViewport(viewport, List.of(1L), List.of(SpotTheme.SUNSET), null);

            then(spotMapper).should()
                .findSpotsInViewport(37.5, 37.6, 127.0, 127.1, PUBLISHED_CODE, List.of(SpotTheme.SUNSET.getCode()), List.of(1L));
        }
        ...
        void passesMultipleThemeCodesToMapper() {
            given(spotMapper.findSpotsInViewport(
                37.5, 37.6, 127.0, 127.1, PUBLISHED_CODE, List.of(SpotTheme.SUNSET.getCode(), SpotTheme.YUNSEUL.getCode()), List.of(1L)))
                .willReturn(List.of());
        ...
        void passesNullToMapper_whenThemeListEmpty() {
            ...
            then(spotMapper).should().findSpotsInViewport(37.5, 37.6, 127.0, 127.1, PUBLISHED_CODE, null, List.of(1L));
        }

        @Test
        @DisplayName("regionId를 mapper에 그대로 전달한다")
        void passesRegionIdToMapper() {
            given(spotMapper.findSpotsInViewport(37.5, 37.6, 127.0, 127.1, PUBLISHED_CODE, null, List.of(1L, 2L)))
                .willReturn(List.of());

            spotQueryService.findSpotsInViewport(viewport, List.of(1L, 2L), null, null);

            then(spotMapper).should().findSpotsInViewport(37.5, 37.6, 127.0, 127.1, PUBLISHED_CODE, null, List.of(1L, 2L));
        }
    }
    ...
    class FindSpots {
        ...
        void successWhenBothCoordinatesNull() {
            given(spotMapper.findSpots(PUBLISHED_CODE, null, null, null, null, null, 0, 6, SortType.RECOMMENDED.getCode()))
                .willReturn(List.of());
            given(spotMapper.countSpots(PUBLISHED_CODE, null, null)).willReturn(0L);
        ...
        void passesThemeCodeToMapper() {
            given(spotMapper.findSpots(PUBLISHED_CODE, List.of(SpotTheme.SUNSET.getCode()), null, null, null, null, 0, 6, SortType.RECOMMENDED.getCode()))
                .willReturn(List.of());
            given(spotMapper.countSpots(PUBLISHED_CODE, List.of(SpotTheme.SUNSET.getCode()), null)).willReturn(0L);
        ...
        void passesMultipleThemeCodesToMapper() {
            ...
            given(spotMapper.findSpots(PUBLISHED_CODE, codes, null, null, null, null, 0, 6, SortType.RECOMMENDED.getCode()))
                .willReturn(List.of());
            given(spotMapper.countSpots(PUBLISHED_CODE, codes, null)).willReturn(0L);
        ...
        void passesRegionIdAndUserIdToMapper() {
            given(spotMapper.findSpots(PUBLISHED_CODE, null, List.of(1L, 2L), 42L, null, null, 0, 6, SortType.RECOMMENDED.getCode()))
                .willReturn(List.of());
            given(spotMapper.countSpots(PUBLISHED_CODE, null, List.of(1L, 2L))).willReturn(0L);
        ...
        void hasNextTrue_whenMorePagesExist() {
            ...
            given(spotMapper.countSpots(PUBLISHED_CODE, null, null)).willReturn(7L);
        ...
        void hasNextFalse_whenLastPage() {
            ...
            given(spotMapper.countSpots(PUBLISHED_CODE, null, null)).willReturn(6L);
        ...
        void mapsSpotRowToSpotItemCorrectly() {
            ...
            given(spotMapper.countSpots(PUBLISHED_CODE, null, null)).willReturn(1L);
