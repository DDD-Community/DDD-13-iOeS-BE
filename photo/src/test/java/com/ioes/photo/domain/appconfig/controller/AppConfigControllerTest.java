...
class AppConfigControllerTest {
    ...
    void shouldReturnConfiguredIosVersionInfo() {
        ...
        ApiResponse<AppConfigResponse> response = controller.getIosAppConfig();
    ...
    void shouldReturnConfiguredAndroidVersionInfo() {
        ...
        ApiResponse<AppConfigResponse> response = controller.getAndroidAppConfig();
    ...
    private AppConfigProperties createProperties() {
        return new AppConfigProperties(createIosConfig(), createAndroidConfig());
    }

    private AppConfigProperties.PlatformConfig createIosConfig() {
        return new AppConfigProperties.PlatformConfig(
            "1.3.0",
            "1.5.0",
            true,
            ...
            List.of(
                new AppConfigProperties.TermsPolicy("TERMS_OF_SERVICE", "서비스 이용약관", "https://example.com/terms"),
                new AppConfigProperties.TermsPolicy("PRIVACY_POLICY", "개인정보처리방침", "https://example.com/privacy")
            )
        );
    }

    private AppConfigProperties.PlatformConfig createAndroidConfig() {
        return new AppConfigProperties.PlatformConfig(
            "2.0.0",
            "2.1.0",
            false,
